...
import "./globals.css"
import { Instrument_Serif, Kodchasan, Geist_Mono, IBM_Plex_Sans} from "next/font/google"
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body className={`${instrumentSerif.variable} ${karla.variable} ${kodchasan.variable} ${geistMono.variable}`}>
        <Header />
        {children}
        <Analytics />
        <SpeedInsights />
